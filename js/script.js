(function() {
  ...
  function translate() {
    ...
    var date = Date.now();
    var str = '20170702000061844'+text.value+date+'rEFlbD2z44L4hBf3ZeFf';
    var md5 = MD5(str);
    var data = 'q=' + text.value + '&from=auto&to=' + lang + '&appid=20170702000061844' + '&salt=' + date + '&sign=' + md5 + "&callback=fn";
    var src = value + data;
    createScript(src);
  }
